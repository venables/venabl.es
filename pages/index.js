  ...
  return (
    <div className="text-gray-800 font-inter">
      <Head>
        ...
        <title>
          👋 Hi, I'm Matt Venables. I build delightful internet things.
        </title>
      ...
      <main className="container max-w-screen-xl px-4 pt-8 pb-12 mx-auto text-center sm:pt-12">
        ...
        <img
          className="w-56 mx-auto transition-shadow duration-1000 ease-in-out border-8 border-teal-200 rounded-full md:w-64 hover:shadow-2xl"
        ...
        <div className="flex justify-center mt-4">
          <a
            ...
            target="_blank"
            className="text-gray-500 transition-colors duration-200 ease-in-out hover:text-gray-800"
          >
          ...
          <a
            ...
            target="_blank"
            className="ml-6 text-gray-500 transition-colors duration-200 ease-in-out hover:text-gray-800"
          >
