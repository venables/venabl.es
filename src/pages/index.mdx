...
I am co-founder and CTO of [Catena Labs](https://catena.xyz), where we're using stablecoins to give AI agents superpowers. Before Catena, I was early at [Circle](https://circle.com) where I helped create the **USDC stablecoin**, which has a market cap of [<USDCSupply />](https://usdc.cool)
